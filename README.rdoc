...
In order to make the exercises easier to understand, movercado-analysis includes actual code from the real Movercado but scaled down and with a lot taken out. The main concepts are:
  ...
  -Apps: Logical workflows that specify how to handle messages.
  -Roles: The classification for a specific user for a specific application.
  -Interactions: History of how users have interacted with Movercado.
...
Change the recipient of your alert message to be movercado-jobs@psi.org.mz. The subject of the email should be: "Final movercado-analysis submission". The body should include your name, your email, and a link to your website.
